...
function About() {
  ...
  const askQuestion = async () => {
    ...
    const tempBotMessage = { role: 'model', parts: [{ text: 'Wait a minute...' }] };
  ...
  return (
    <div className="flex flex-col h-screen p-10">
      <div className="flex-1 max-h-[80vh] overflow-y-auto">
        <div className="prose max-w-none font-raleway space-y-4 px-4">
          {history.map((msg, idx) => (
                ...
                {msg.role === 'user' ? (
                  ...
                  <ReactMarkdown
                    ...
                    components={{
                      ...
                      code: (props) => (
                        <code className="bg-zinc-200 text-sm px-1 rounded">{props.children}</code>
                      ),
                      pre: (props) => (
